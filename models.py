...
def deep_cluster_train(dataloader, model, loss_criterion, net_optimizer, annxed_layers_optimizer, epoch, device, return_inputs_outputs_targets_losses=False, verbose=True, checkpoint=0):
    """Training of the CNN.
        Args:
